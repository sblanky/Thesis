...
What follows is the results of the synthesis of \glspl{turbostratic carbon} of \acrfullpl{ucb}. The synthesis is described in section \ref{s:synthetic}, and the rationale for the choice of \acrshortpl{ucb} as a carbon precursor, is described in subsection \ref{ss:cbs}. Details of analytical techniques used herein can be found in sections \ref{s:composition_morphology}-\ref{s:porosimetry}.
...
\begin{figure}[b!]
    ...
    \captionof{figure}{\acrshort{tem} (a, c) and \acrshort{edx}-\acrshort{tem} (b, d) images of hD-0700$'$ at sites 1 (a, b) and 3 (c, d). (b) and (d) show distribution of \ce{Ti} and \ce{Al} particles respectively.}
    \label{fig:EDX_TEM}

    \vspace{10pt}
    
    \captionof{table}{Concentrations of \ce{C}, \ce{O}, \ce{Al} and \ce{Ti} at three different sites in hD-4700 according to EDX-TEM }
    \label{tb:cb_edx}
    \begin{tabularx}{\textwidth}{llXlXlX}
    \toprule
...
\section{\texorpdfstring{\ce{CO2} uptake}{CO2 uptake}}
...
\begin{figure}[ht!]
    \centering
    \captionof{table}{\ce{CO2} uptakes (measured at \qty{25}{\degreeCelsius}) at \qtylist[list-units=single]{1;20}{\bar} for samples hC-4\textit{TTT} and hD-4\textit{TTT}.}
    \label{tb:cb_co2}
    ...
    \captionof{figure}{\ce{CO2} uptake isotherms measured at \qty{25}{\degreeCelsius} for samples hC-4\textit{TTT} and hD-4\textit{TTT}.}
    \label{fig:cb_co2}
\end{figure}
