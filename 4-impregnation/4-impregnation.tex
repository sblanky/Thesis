...
What follows is the results of the synthesis of \glspl{turbostratic carbon} \textit{via} impregnation techniques. The synthesis is described in section \ref{s:synthetic}, and the rationale for the impregnation techniques is described in subsection \ref{ss:impregnation}. Details of analytical techniques used herein can be found in sections \ref{s:composition_morphology}-\ref{s:porosimetry}.
